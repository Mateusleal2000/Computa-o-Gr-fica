...
std::tuple<double, double> Cone::intersectRay(Eigen::Vector3d O, Eigen::Vector3d D) {
    double a, b, c;
    double delta;
...
double Cone::onSurface(Eigen::Vector3d O, Eigen::Vector3d D, double t1, double t2) {
